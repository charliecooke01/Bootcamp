...
Follow the [README.md](https://github.com/Step8Up-SBC/lms-3000#readme) in the repository to set up the project locally.

## Key Learnings

- Collaborative development using **GitHub**.
- Addressing real-world challenges with **React** and **Node/Sequelize** development.
- Effective branching strategies and managing **Pull Requests**.
- Working with [GitHub Issues](https://github.com/Step8Up-SBC/lms-3000/issues)
...
- For Backend: Ensure the backend logic integrates seamlessly with the frontend, and follow proper security practices.
